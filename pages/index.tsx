...
const Home: NextPage = () => {
  return (
    <div className='h-full w-full '>
      ...
      <div className="w-full h-40 absolute bg-black">
        <div className="sm:ml-0 ml-5 mr-0 mt-3 md:pl-80 md:pr-80 sm:w-full h-full bg-black">
          <Image src="/logo.png" width={200} height={40} className="w-40 h-16" alt="Tailwind Play" />
        </div>
      </div>
